...
<body class="bg-dark">
    <div class="container bg-primary">
        <div class="d-flex justify-content-end">
            ...
            <h3 class="mt-3 text-center"><strong>Tabulation Sheet</strong></h3>
...
?>
            <div class="col-md-4">
                <div class="card bg-info text-center">
                    <a class="card-body text-light" href="tabulation_view.php?course_id=<?php echo $row['id']; ?>">
